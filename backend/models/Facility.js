...
const facilitySchema = new mongoose.Schema({
  ...
  parentFacility: { type: mongoose.Schema.Types.ObjectId, ref: 'Facility', default: null },
  specializations: [{
    type: String,
  ...
  diagnosticServices: [{
    ...
    waitTimeHours: { type: Number, default: 2 }
  }],
  accreditation: {
    type: String,
  ...
  averageResponseTime: { type: Number, default: 15 },
